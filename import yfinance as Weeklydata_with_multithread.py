...
def get_yahoo_finance_historical_data(stock_symbols, start_date, end_date, interval='1wk'):
    data = yf.download(stock_symbols, start=start_date, end=end_date, interval=interval)
...
def get_and_save_data(stock_symbol, start_date, end_date):
    try:
        stock_data = get_yahoo_finance_historical_data(stock_symbol, start_date, end_date, interval='1wk')
